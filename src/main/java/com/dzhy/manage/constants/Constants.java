...
public final class Constants {
     ...
     * 表头
     */
    public static final String PRODUCE_TITLE = "综合报表";
    ...
    public static final String MU_GONG_COMMENT = "木工备注";

    public static final String YOU_FANG = "油房";

    public static final String YOU_FANG_COMMENT = "油房备注";

    public static final String BAO_ZHUANG = "包装";

    public static final String BAO_ZHUANG_COMMENT = "包装备注";

    public static final String TE_DING = "特定";

    public static final String TE_DING_COMMENT = "特定备注";

    public static final String BEI_JING = "北京";

    public static final String BEI_JING_COMMENT = "北京备注";

    public static final String BEI_JING_TE_DING = "北京特定";

    public static final String BEI_JING_TE_DING_COMMENT = "北京特定备注";

    public static final String BEN_DI_HE_TONG = "本地合同";

    public static final String BEN_DI_HE_TONG_COMMENT = "本地合同备注";

    public static final String WAI_DI_HE_TONG = "外地合同";

    public static final String WAI_DI_HE_TONG_COMMENT = "外地合同备注";
